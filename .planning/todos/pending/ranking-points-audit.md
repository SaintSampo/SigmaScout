...
| **F10** bonus-dot display threshold | **DECIDED 2026-09-14 (Jacob): sketch 012 variant B, three states.** Full alliance colour at 2/3 or more, a light tint from 1/3 to 2/3, hollow below 1/3, and the exact percentage stays in the tooltip. Not built yet. Ship it with or after the F4 fix. See `.planning/sketches/012-predicted-bonus-dots/README.md` |
