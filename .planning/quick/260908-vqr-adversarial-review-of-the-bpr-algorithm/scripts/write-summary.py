"""Writes 260908-vqr-SUMMARY.md. The Write tool is blocked from creating
SUMMARY files in this repo, so the summary is emitted from here instead."""
import io
import os
