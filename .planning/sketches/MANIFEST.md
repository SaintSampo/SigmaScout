...
| 019 | bonus-dot-tier-contrast | The three tier predicted bonus dot shipped with a 60% fill vs a 25% tint and the two are too hard to tell apart at 14px. What should separate likely from toss-up? | **F — Jacob's mix**: hatched toss-up (30% stripes), pip for actual not earned, black letters, predicted likely drawn exactly as actual earned (30% tint; the shipped 60% fill was too dark). Supersedes 012 C. Sketch only, not yet built | match-table, bonus-rp, uncertainty, prediction, accessibility |
