...
| 012 | predicted-bonus-dots | Once F4 makes bonus odds honest, how should a predicted bonus dot render when many alliances are true toss-ups? | **B — three states** | match-table, bonus-rp, uncertainty, prediction |
