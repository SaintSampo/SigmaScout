...
> **Retired 2026-09-13:** this document's measurement harness, `scripts/measureRandomSchedules.ts`, was retired along with the licensed templates (quick task 260913-pnp) and cannot be re-run.
