...
describe("rpRuleModuleForSeason", () => {
  it("throws for an unregistered season, naming every registered season (2021 stays absent — no standard season was played)", () => {
    expect(() => rpRuleModuleForSeason(2021)).toThrow(/2018, 2019, 2020, 2022, 2023, 2024, 2025, 2026/);
  });

  it("returns the registered module for every season 2018-2020, 2022-2026", () => {
    for (const season of [2018, 2019, 2020, 2022, 2023, 2024, 2025, 2026] as const) {
...
describe("RP_REGISTERED_SEASONS", () => {
  it("is the sorted tuple 2018-2020, 2022-2026 (2021 absent — no standard season was played)", () => {
    expect(RP_REGISTERED_SEASONS).toEqual([2018, 2019, 2020, 2022, 2023, 2024, 2025, 2026]);
  });
});
...
describe("winRp per season (Pitfall 2)", () => {
  it("is 2 for 2018, 2019, 2020, 2022, 2023, 2024", () => {
