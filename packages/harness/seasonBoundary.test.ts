...
describe("seasonBoundaryFor", () => {
  it("D-2: is byte-identical to the stale-constant behaviour over 2022-2026, the historical contiguous range harness --seasons 2022-2026 still replays (publish:seasons itself now covers the gapped ten-season corpus, 2016-2020,2022-2026)", () => {
