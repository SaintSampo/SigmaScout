...
describe("ROUNDING_RULE.percentile", () => {
  ...
  it("Object.keys(ROUNDING_RULE) is exactly this set — a future unannounced key is a red test here, and only here", () => {
...
describe("ROUNDING_RULE.rankingPoints", () => {
