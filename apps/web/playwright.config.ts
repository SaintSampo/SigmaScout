...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      // about. touch-action-vertical-scroll.spec.ts and
      // tab-strip-trigger-sizing.spec.ts (07-UAT.md G-4/G-5, real-device UAT
      // follow-up) reuse the same 390px real-device-reported width rather
      // than a new one.
